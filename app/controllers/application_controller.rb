class ApplicationController < ActionController::Base
  ...
  def redir_editores
    if current_usuario.editor?
      ...
      @cargos = ["Administrador","Analista Financeiro","Contador","Economista","Analista Administrativo","Responsável por Setorial","Assessor","Diretor","Secretarário","Diretor Adjunto","Cuidador","Intérprete","Agente de Portaria","Auxiliar Operacional de Serviços Diversos" ,"Especialista em Educaçao","Pedagogo","Auxiliar Educacional","Professor","Agente Administrativo","Datilógrafo","Auxiliar Administrativo"].sort
